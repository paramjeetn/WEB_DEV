...
app.post("/submit", (req, res) => {
  const randmadj=(Math.floor(Math.random()*adj.length));
  const randmnoun=(Math.floor(Math.random()*noun.length));
  

  res.render("index.ejs",{first:adj[randmadj],second:noun[randmnoun]});
